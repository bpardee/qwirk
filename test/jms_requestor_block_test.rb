...
class CharCountWorker < BaseReplyWorker
...
class LengthWorker < BaseReplyWorker
  virtual_topic 'test_string'
...
class ReverseWorker < BaseReplyWorker
  virtual_topic 'test_string'
...
class TripleWorker < BaseReplyWorker
  virtual_topic 'test_string'
  response :marshal => :string
  ...
  context 'jms request with block' do
    ...
    context "real publishing" do
      ...
      should "handle replies" do
        ...
        publisher = Qwirk::Adapter::JMS::Publisher.new(:virtual_topic_name => 'test_string', :response_time_to_live => 10000, :marshal => :string)
        cc_val = {'f' => 1, 'o' => 4, 'b' => 1}
    ...
    context "dummy publishing" do
      ...
      should "handle replies" do
        ...
        publisher = Qwirk::Adapter::JMS::Publisher.new(:virtual_topic_name => 'test_string', :response => true, :marshal => :string)
        cc_val = {'f' => 1, 'o' => 4, 'b' => 1}
